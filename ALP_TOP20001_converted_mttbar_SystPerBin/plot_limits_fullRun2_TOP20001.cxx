{
  ...
  vector<vector<double>> v_mttbar_SystPerBin = readIn_expected(
  ...
  vector<vector<double>> v_mttbarInCosthetastar = readIn_expected(
    "../ALP_int_neg/limits_exp_fullRun2.txt",
    // "../ALP_reducedSysts/limits_exp_fullRun2.txt",
  ...
  auto gr_exp_mttbar_SystPerBin = new TGraph(fa_mttbar.size(), &(fa_mttbar[0]), &(v_mttbar_SystPerBin.at(2)[0]));
  gr_exp_mttbar_SystPerBin->SetLineColor(kGreen);
  gr_exp_mttbar_SystPerBin->SetLineStyle(2);
  gr_exp_mttbar_SystPerBin->SetLineWidth(2);
  gr_exp_mttbar_SystPerBin->SetMarkerStyle(8);
  gr_exp_mttbar_SystPerBin->SetMarkerColor(kGreen);
  multigraph->Add(gr_exp_mttbar_SystPerBin, "same lp");
  ...
  legend->AddEntry(gr_exp_mttbar, "CMS-TOP-20-001: m(t#bar{t})","l");
  legend->AddEntry(gr_exp_mttbar_SystPerBin, "CMS-TOP-20-001: m(t#bar{t}) (corr. syst.)","l");
  ...
  legend->AddEntry(gr_exp_mttbarInCosthetastar, "expected limits ","l");
  ...
  c1->Print("Limits_exp_fullRun2.pdf");
  // c1->Print("ExpectedLimits_fullRun2_withTOP20001.pdf");
