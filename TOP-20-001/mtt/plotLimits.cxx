{
  ...
  // TString save_dir = "/nfs/dust/cms/user/jabuschh/combine/CMSSW_10_2_13/src/HiggsAnalysis/CombinedLimit/TOP-20-001/cts_mtt/";
  ...
  for(int a=0; a<2; ++a){ // a=0: negint, a=1: posint
    ...
    for(int b=0; b<2; ++b){ // b=0: limits on poi sqrt(mu), b=1: limits on product of WCs
      if(b == 1){
      ...
      legend->AddEntry(g_exp, "Expected limit", "l");
