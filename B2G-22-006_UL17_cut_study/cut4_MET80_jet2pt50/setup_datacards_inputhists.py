...
inputdirs = {
    "UL17": {
        "electron": "/nfs/dust/cms/user/deleokse/RunII_106_v2/DNN_UL17_electron_cuts_4/",
        "muon": "/nfs/dust/cms/user/deleokse/RunII_106_v2/DNN_UL17_muon_cuts_4/"
    }
}
...
regions["SR_bin3_TopTag"]   = "Zprime_SystVariations_DNN_output0_TopTag_abs_thetastar_bin3"
regions["SR_bin3_NoTopTag"] = "Zprime_SystVariations_DNN_output0_NoTopTag_abs_thetastar_bin3"
regions["SR_bin4_TopTag"]   = "Zprime_SystVariations_DNN_output0_TopTag_abs_thetastar_bin4"
regions["SR_bin4_NoTopTag"] = "Zprime_SystVariations_DNN_output0_NoTopTag_abs_thetastar_bin4"
...
def createCombineInput():
    ...
    for entry in list_inputdirs:
        ...
        for fa in fas:
            ...
            filename_out = "inputHistograms_" + year + "_" + channel + "_fa" + str(fa) + ".root"
            ...
            datacard_name = "datacard_" + year + "_" + channel + "_fa" + str(fa) + ".dat"
